...
module.exports.languages = {
 "en": {
    "moduleInfo": "╭──────•◈•──────╮\n |        ༺ভেজাল-মাল বসের গ্যাং এ স্বাগতম༻\n |●𝗡𝗮𝗺𝗲: •—» %1 «—•\n |●𝗨𝘀𝗮𝗴𝗲: %3\n |●𝗗𝗲𝘀𝗰𝗿𝗶p𝘁𝗶𝗼𝗻: %2\n |●𝗖𝗮𝘁𝗲𝗴𝗼𝗿𝘆: %4\n |●𝗪𝗮𝗶𝘁𝗶𝗻𝗴 𝘁𝗶𝗺𝗲: %5 seconds(s)\n |●𝗣𝗲𝗿𝗺𝗶𝘀𝘀𝗶𝗼𝗻: %6\n |𝗠𝗼𝗱𝘂𝗹𝗲 𝗰𝗼𝗱𝗲 𝗯𝘆\n |•—» Ullash ッ «—•\n╰──────•◈•──────╯",
...
const text = `╭──────•◈•──────╮\n│𝗨𝘀𝗲 ${prefix}help [Name?]\n│𝗨𝘀𝗲 ${prefix}help [Page?]\n│𝗡𝗔𝗠𝗘 𝗢𝗪𝗡𝗘𝗥 : │ ༺ভেজাল⚜️মাল༻\n│𝗧𝗢𝗧𝗔𝗟 : [${arrayInfo.length}]\n│📛🄿🄰🄶🄴📛 :  [${page}/${Math.ceil(arrayInfo.length/numberOfOnePage)}]\n╰──────•◈•──────╯`; 
    var link = [
"https://i.imgur.com/YM6ZA7Y.jpeg", "https://i.imgur.com/YM6ZA7Y.jpeg", "https://i.imgur.com/YM6ZA7Y.jpeg", "https://i.imgur.com/Q74pDhm.jpeg",
"https://i.imgur.com/YM6ZA7Y.jpeg",
"https://i.imgur.com/Q74pDhm.jpeg",
"https://i.imgur.com/Q74pDhm.jpeg",
    ]
